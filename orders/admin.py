...
class OrderAdmin(admin.ModelAdmin):
    ...
    search_fields = ("id", "last_name", "email", "phone", "balikovna_code", "zip_code", "tracking_code")
    inlines = [OrderItemInline]
    readonly_fields = ("created", "updated", "tracking_link")

    fieldsets = (
        ("Zákazník", {"fields": ("first_name", "last_name", "email", "phone")}),
        ("Doručení", {"fields": ("delivery_method", "street", "city", "zip_code", "balikovna_id", "balikovna_code")}),
